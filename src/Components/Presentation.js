...
export default function Presentation() {
  return (
    <div className="h-screen overflow-hidden">
        <div className='h-5/6 bg-gradient-to-tr from-Abd-el-Bg1 to-Abd-el-Bg2 flex drop-shadow-2xl overflow-hidden flex-col tablet:justify-stretch tablet:flex-row'>
            ...
            <motion.img initial={{opacity: 0, x : -10}} animate={{opacity: 1,x : 0}} transition={{delay: 0.5}} src={img} className="hidden tablet:block"></motion.img>
