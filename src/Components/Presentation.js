...
export default function Presentation() {
  return (
    <div className="h-screen overflow-hidden">
        <div className='h-4/6 bg-gradient-to-tr from-Abd-el-Bg1 to-Abd-el-Bg2 sm:flex drop-shadow-2xl overflow-hidden sm:justify-stretch sm:h-5/6'>
            <div className='flex justify-center'><motion.h1 initial={{opacity: 0,y : 10}} animate={{opacity: 1 , y: 0}} transition={{delay: 1}} className="font-Button text-xl ml-5">Portfolio</motion.h1></div>
            ...
            <div className='flex justify-center sm:justify-end'><div className='flex flex-col w-4/6 justify-start mt-7'>
                ...
                <div className='flex text-2xl font-thin justify-evenly mt-5 text-center gap-3'>
